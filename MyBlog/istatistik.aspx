<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="istatistik.aspx.cs" Inherits="MyBlog.istatistik" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"><link href="web2/css/style.css" rel="stylesheet" />
    ...
    <div class="total-world">
        ...
        <div class="site-report">
            ...
            <p>CV projemizin admin paneli kısmındasınız. Keyifli kodlamalar dileriz.</p>
        </div>
        <div class="clearfix"></div>
    </div>
</asp:Content>
