<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnaSayfa.aspx.cs" Inherits="MyBlog.AnaSayfa" %>
...
<body>
    <div class="sidenav text-center">
        <div class="side_top">
            <a href="Login.aspx">
                <img src="web/images/profil.jpg" alt="news image" class="img-fluid navimg">
            </a>
            <h1 class="top_hd mt-2" style="color:white">Hamza Kılıç</h1>
            ...
            <div class="nav-top">
                <nav class="mnu mx-auto">
                    ...
                    <ul class="menu">
                        ...
                        <li class="mt-sm-3"><a href="#work" class="scroll">Çalışmalarım</a></li>
    ...
    <div class="main">
        ...
        <section class="services" id="work">
            <div class="container">
                <h3 class="w3_head mb-4 text-left">Çalışmalarım</h3>
